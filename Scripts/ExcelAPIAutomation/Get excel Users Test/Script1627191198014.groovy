...
'Printing Get Excel Users API response'
println('Get Excel Users API response' + getexcelusersResponse.getResponseText())

'Verifying if Get Excel Users API response is 200'
