...
'Sending request to delete User Not Exist API and capturing response in deleteUserNotExistResponse variable'
deleteUserNotExistResponse = WS.sendRequest(findTestObject('ExcelAPIAutomation/Delete User not exist', [('cloud_auth_token') : GlobalVariable.cloud_auth_token
            , ('newuser') : GlobalVariable.newuser]))

'Printing Delete User Not Exist API Response'
println(deleteUserNotExistResponse.getResponseText())

'Parsing Delete User Not Exist API Response and extracting value of success key and verifying whether if it is false'
WS.verifyElementPropertyValue(deleteUserNotExistResponse, '[0].success', false)

'Parsing Delete User Not Exist API Response and extracting value of message key and verifying whether it is as per expected value'
WS.verifyElementPropertyValue(deleteUserNotExistResponse, '[0].message', ('User ' + "$newuser") + ' does not exist.')
